...
WSGI_APPLICATION = 'bitflip.wsgi.application'
...
if USE_LOCAL:
    DATABASES = {
        ...
        'NAME': config('LOCAL_DB_NAME', default='bitflip_local'),
        'USER': config('LOCAL_DB_USER', default='jaycruz'),
        'PASSWORD': config('LOCAL_DB_PASSWORD', default='6969'),
